...
class StoreFollowerBloc extends Bloc<StoreFollowerEvent, StoreFollowerState> {
  StoreFollowerBloc() : super(StoreFollowerState()) {
    ...
    on<GetProductsByFollowerStoresEvent>(
      _onGetProductsByFollowerStoresEvent,
    );
  ...
  FutureOr<void> _onGetProductsByFollowerStoresEvent(
    ...
    await ApiService.getMethod(
      ...
      log(response.data.toString());
      final apiResponse = ApiResponseModel<List<ProductCatalogModel>>.fromJson(
        response.data,
  ...
  FutureOr<void> _onGetStoreFollowersCountEvent(
    ...
    await ApiService.getMethod(
      ...
      emit(
        state.copyWith(
          getStoreFollowersCountStatus: GetStoreFollowersCountStatus.success,
      ...
      emit(
        state.copyWith(
          getStoreFollowersCountStatus: GetStoreFollowersCountStatus.failure,
          errorMessage: apiErrorMessage(error),
        ),
      );
    }).onError((error, stackTrace) {
