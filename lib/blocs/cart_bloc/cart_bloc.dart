...
class CartBloc extends Bloc<CartEvent, CartState> {
  ...
  FutureOr<void> _onDeleteCartItemsEvent(
    ...
    emit(
      state.copyWith(deleteCartItemsStatus: DeleteCartItemsStatus.loading),
    );
    await ApiService.deleteMethod(
      ...
      add(GetCartItemsEvent());
      emit(
        state.copyWith(deleteCartItemsStatus: DeleteCartItemsStatus.success),
      );
    }).catchError((error) {
      log(error.toString());
      emit(
  ...
  FutureOr<void> _onGetCartItemsEvent(
    ...
    await ApiService.getMethod(endPoint: 'Cart/GetCartItems').then((
      response,
    ) {
      log(response.data.toString());
